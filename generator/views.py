...
def resume_list(request):
    ...
    return render(request, 'generator/resume_list.html', {'resumes': resumes})
...
def portfolio_templates(request):
    ...
    return render(request, 'generator/portfolio_templates.html', {'templates': templates})

@login_required
def generate_portfolio(request, template_id, resume_id):
